...
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/resources/css/AddPharmacy.css">
			...
			<h:form id="form" styleClass="form-container">
				...
				<div class="form-row">
					<div class="form-group">
						<label class="form-label"><span style="color: red">*</span>
							Pharmacy Name</label>
						<h:inputText id="pharmacyName" value="#{pharmacy.pharmacyName}"
					...
					<div class="form-group">
						...
						<h:inputText id="licenseNo" value="#{pharmacy.licenseNo}"
							styleClass="form-input" />
				...
				<div class="form-row">
					<div class="form-group">
						...
						<h:inputText id="gstNo" value="#{pharmacy.gstNo}"
							styleClass="form-input" />
						<h:message for="gstNo" style="color:red" />
					</div>
					<div class="form-group">
						<label class="form-label"><span style="color: red">*</span>Email
						</label>
						<h:inputText id="email" value="#{pharmacy.email}"
							styleClass="form-input" />
				...
				<div class="form-row">
					<div class="form-group">
						...
						<h:inputText id="contactNo" value="#{pharmacy.contactNo}"
							styleClass="form-input" />
					...
					<div class="form-group">
						...
						<h:inputText id="pinCode" value="#{pharmacy.pinCode}"
							styleClass="form-input" />
				...
				<div class="form-row">
					<div class="form-group">
						<label class="form-label"><span style="color: red">*</span>
							City</label>
						<h:inputText id="city" value="#{pharmacy.city}"
							styleClass="form-input" />
					...
					<div class="form-group">
						<label class="form-label"><span style="color: red">*</span>
							State</label>
						<h:inputText id="state" value="#{pharmacy.state}"
							styleClass="form-input" />
				...
				<div class="form-row">
					...
					<div class="form-group">
						...
						<h:inputText id="addressLine1" value="#{pharmacy.addressLine1}"
							styleClass="form-input" />
				...
				<!-- Submit Button -->
				<h:commandButton id="submitBtn" value="Register"
					action="#{controller.registerPharmacy}" styleClass="submit-button"
					style="margin-top: 15px;"
					onclick="return validateTermsOnly(event);" />

				<h:commandButton id="backBtn" value="Back"
					action="#{controller.returnToBack }" styleClass="submit-button" />
