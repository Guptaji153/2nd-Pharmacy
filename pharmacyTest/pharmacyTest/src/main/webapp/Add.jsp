...
<f:view>
    <h:form id="form" styleClass="form-container">
        ...
        <div class="form-row" style="margin-top: 20px; display: flex; align-items: center;">
            <h:selectBooleanCheckbox id="termsCheckbox" />
            <h:outputText value=" I accept all " style="margin-left: 10px;" />
            <h:outputLink value="terms.jsp" target="_blank" style="margin-left: 5px;">Terms and Conditions</h:outputLink>
        </div>
